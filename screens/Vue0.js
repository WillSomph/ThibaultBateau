...
const Vue0 = ({ navigation }) => {
    ...
    return (
        ...
        >
            ...
            <Text style={styles.centeredText}>Produits selon la saison, Livraison sur Paris</Text> 
            ...
            <Text style={styles.centeredText}>www.facebook.com/lebateaudethibault</Text> 
                ...
                <View style={styles.row}>
                    ...
                    >
                        <Image source={require('../assets/images/poisson.png')} style={styles.image} />
                ...
                <View style={styles.row}>
                    ...
                    >
                        <Image source={require('../assets/images/recette.png')} style={styles.image} />
                        ...
                        <TouchableOpacity
                            ...
                            onPress={handlePress}
                        >
                            <Image source={require('../assets/images/tourteau.png')} style={styles.image} />
