...
const buttonList = [
  {
    icon: require('../assets/images/delaBrise_icon.png'),
    text: "De la Brise",
    path: "SingleBateau",
  },
  {
    icon: require('../assets/images/saphir_icon.png'),
    text: "Saphir",
    path: "SingleBateau",

  },
  {
    icon: require('../assets/images/gastMicher_icon.png'),
    text: "Gast Micher",
    path: "SingleBateau",

  },
  {
    icon: require('../assets/images/aquilon_icon.png'),
    text: "Aquilon",
    path: "SingleBateau",
