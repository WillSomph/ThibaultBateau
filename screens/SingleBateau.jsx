...
const SingleBateau = (props) => {
  let bateaux = props.route.params.data;
  // const img = bateaux.icon;
  ...
  return (
    ...
    >
      <View style={styles.containerImg}>
        <Text style={styles.title}>{bateaux.text}</Text>

        <Image
          style={styles.imageAvant}
          resizeMode="contain"
          source={bateaux.icon}
        // source={img.replace('_icon', '')}
        />
